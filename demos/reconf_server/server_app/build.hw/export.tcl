...
proc reconos_hw_setup {new_project_name new_project_path reconos_ip_dir} {
    ...
    create_bd_cell -type ip -vlnv cs.upb.de:reconos:timer:1.0 timer_0
		...
		create_bd_cell -type ip -vlnv cs.upb.de:reconos:rt_filterdemo:[str range 1.00.a 0 2] "slot_0"
	
	
	create_bd_cell -type ip -vlnv cs.upb.de:reconos:rt_filterdemo:[str range 1.00.a 0 2] "slot_1"
		...
		create_bd_cell -type ip -vlnv cs.upb.de:reconos:reconos_fifo_async:1.0 "reconos_fifo_osif_hw2sw_0"
	create_bd_cell -type ip -vlnv cs.upb.de:reconos:reconos_fifo_async:1.0 "reconos_fifo_osif_sw2hw_0"
	create_bd_cell -type ip -vlnv cs.upb.de:reconos:reconos_fifo_async:1.0 "reconos_fifo_memif_hwt2mem_0"
	create_bd_cell -type ip -vlnv cs.upb.de:reconos:reconos_fifo_async:1.0 "reconos_fifo_memif_mem2hwt_0"
	
	# Connect clock signals
	# FIFOs
	connect_bd_net [get_bd_pins reconos_clock_0/CLK0_Out] [get_bd_pins "reconos_fifo_osif_hw2sw_0/FIFO_S_Clk"]
	connect_bd_net [get_bd_pins reconos_clock_0/CLK1_Out] [get_bd_pins "reconos_fifo_osif_sw2hw_0/FIFO_S_Clk"]
	connect_bd_net [get_bd_pins reconos_clock_0/CLK0_Out] [get_bd_pins "reconos_fifo_memif_hwt2mem_0/FIFO_S_Clk"]
	connect_bd_net [get_bd_pins reconos_clock_0/CLK1_Out] [get_bd_pins "reconos_fifo_memif_mem2hwt_0/FIFO_S_Clk"]
	
	connect_bd_net [get_bd_pins reconos_clock_0/CLK1_Out] [get_bd_pins "reconos_fifo_osif_hw2sw_0/FIFO_M_Clk"]
	connect_bd_net [get_bd_pins reconos_clock_0/CLK0_Out] [get_bd_pins "reconos_fifo_osif_sw2hw_0/FIFO_M_Clk"]
	connect_bd_net [get_bd_pins reconos_clock_0/CLK1_Out] [get_bd_pins "reconos_fifo_memif_hwt2mem_0/FIFO_M_Clk"]
	connect_bd_net [get_bd_pins reconos_clock_0/CLK0_Out] [get_bd_pins "reconos_fifo_memif_mem2hwt_0/FIFO_M_Clk"]
	
	create_bd_cell -type ip -vlnv cs.upb.de:reconos:reconos_fifo_async:1.0 "reconos_fifo_osif_hw2sw_1"
	create_bd_cell -type ip -vlnv cs.upb.de:reconos:reconos_fifo_async:1.0 "reconos_fifo_osif_sw2hw_1"
	create_bd_cell -type ip -vlnv cs.upb.de:reconos:reconos_fifo_async:1.0 "reconos_fifo_memif_hwt2mem_1"
	create_bd_cell -type ip -vlnv cs.upb.de:reconos:reconos_fifo_async:1.0 "reconos_fifo_memif_mem2hwt_1"
	
	# Connect clock signals
	# FIFOs
	connect_bd_net [get_bd_pins reconos_clock_0/CLK0_Out] [get_bd_pins "reconos_fifo_osif_hw2sw_1/FIFO_S_Clk"]
	connect_bd_net [get_bd_pins reconos_clock_0/CLK1_Out] [get_bd_pins "reconos_fifo_osif_sw2hw_1/FIFO_S_Clk"]
	connect_bd_net [get_bd_pins reconos_clock_0/CLK0_Out] [get_bd_pins "reconos_fifo_memif_hwt2mem_1/FIFO_S_Clk"]
	connect_bd_net [get_bd_pins reconos_clock_0/CLK1_Out] [get_bd_pins "reconos_fifo_memif_mem2hwt_1/FIFO_S_Clk"]
	
	connect_bd_net [get_bd_pins reconos_clock_0/CLK1_Out] [get_bd_pins "reconos_fifo_osif_hw2sw_1/FIFO_M_Clk"]
	connect_bd_net [get_bd_pins reconos_clock_0/CLK0_Out] [get_bd_pins "reconos_fifo_osif_sw2hw_1/FIFO_M_Clk"]
	connect_bd_net [get_bd_pins reconos_clock_0/CLK1_Out] [get_bd_pins "reconos_fifo_memif_hwt2mem_1/FIFO_M_Clk"]
	connect_bd_net [get_bd_pins reconos_clock_0/CLK0_Out] [get_bd_pins "reconos_fifo_memif_mem2hwt_1/FIFO_M_Clk"]
	

	
        # Add connections between FIFOs and other modules
	        connect_bd_intf_net [get_bd_intf_pins "slot_0/OSIF_Hw2SW"] [get_bd_intf_pins "reconos_fifo_osif_hw2sw_0/FIFO_M"]
        connect_bd_intf_net [get_bd_intf_pins "slot_0/OSIF_Sw2Hw"] [get_bd_intf_pins "reconos_fifo_osif_sw2hw_0/FIFO_S"]
        ...
        connect_bd_intf_net [get_bd_intf_pins "slot_0/MEMIF_Hwt2Mem"] [get_bd_intf_pins "reconos_fifo_memif_hwt2mem_0/FIFO_M"]
        connect_bd_intf_net [get_bd_intf_pins "slot_0/MEMIF_Mem2Hwt"] [get_bd_intf_pins "reconos_fifo_memif_mem2hwt_0/FIFO_S"]
	...
	# Misc
        ...
        connect_bd_intf_net [get_bd_intf_pins "slot_1/OSIF_Hw2SW"] [get_bd_intf_pins "reconos_fifo_osif_hw2sw_1/FIFO_M"]
        connect_bd_intf_net [get_bd_intf_pins "slot_1/OSIF_Sw2Hw"] [get_bd_intf_pins "reconos_fifo_osif_sw2hw_1/FIFO_S"]
        ...
        connect_bd_intf_net [get_bd_intf_pins "slot_1/MEMIF_Hwt2Mem"] [get_bd_intf_pins "reconos_fifo_memif_hwt2mem_1/FIFO_M"]
        connect_bd_intf_net [get_bd_intf_pins "slot_1/MEMIF_Mem2Hwt"] [get_bd_intf_pins "reconos_fifo_memif_mem2hwt_1/FIFO_S"]
